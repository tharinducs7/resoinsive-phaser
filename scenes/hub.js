...
export default class Hub extends Phaser.Scene {
    ...
    preload() {
        ...
        this.creditsTxt = this.add.text(this.canvasWidth / 2, this.canvasHeight - 22, 'randomState', { fontFamily: 'Arial', fontSize: '18px', color: '#000', }).setOrigin(.5).setDepth(1)
    }
    ...
    update() {
        if (this.handlerScene.sceneRunning === 'Intro') {
